...
> **Target Release**: Q4 2026 / v1.0 Pipeline  
...
- [x] **Fasa 1: Friendship State Engine**: Tambahkan field `friendship` dan metode interaksi di `core/companion_store.py`.
- [x] **Fasa 2: Treat Physics & Animation**: Buat fungsi simulasi gravitasi dan rendering sprite treat di `ui/treat_overlay.py`.
- [x] **Fasa 3: Pet Pathfinding AI**: Implementasikan state `STATE_SEEKING_FOOD` dan logika jalan menghampiri makanan.
- [x] **Fasa 4: Context Menu & Bag Drop**: Tambahkan opsi *"Drop Treat"* di klik kanan pet dan tombol di tab Bag.
- [x] **Fasa 5: Unit Tests & Verifikasi**: Tulis test suite di `tests/test_feeding.py`, pastikan lulus 100%.
